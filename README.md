...
<br>
Our aim is to build a Machine Learning model which can detect the pose of a person doing Yoga.We are using Yoga82 Dataset \href{https://sites.google.com/view/yoga-82/home}{[Link to Dataset]} to train and test our model.
<br>
